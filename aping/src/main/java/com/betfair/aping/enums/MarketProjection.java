...
public enum MarketProjection {
	...
	MARKET_DESCRIPTION,
	/**
	 * [WARNING - was added by me] If not selected then the start time will not
	...
	RUNNER_DESCRIPTION,
	/**
	 * [WARNING - was added by me] If not selected then the runner metadata will
	 * not be returned with marketCatalogue. If selected then RUNNER_DESCRIPTION
